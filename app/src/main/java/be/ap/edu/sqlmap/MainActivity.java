...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Map instantiëren, tilesource instellen, zoom & touchcontrols instellen
        mapView = (MapView)findViewById(R.id.mapview);
        mapView.setTileSource(TileSourceFactory.MAPNIK);
        mapView.setBuiltInZoomControls(true);
        mapView.setMultiTouchControls(true);
        mapView.getController().setZoom(18);
        // default = donkvijverstraat
        mapView.getController().setCenter(new GeoPoint(51.213356, 4.248209));
        ...
        try {
            for (Marker m : helper.getAllMarkers()) {
                GeoPoint gp = new GeoPoint(m.getLat(), m.getLon());
                addMarker(gp);
                System.out.println(gp.getLatitude());
            }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch(actionType) {
            case MotionEvent.ACTION_UP:
                ...
                Intent nextScreenIntent = new Intent(this, SaveMarkerActivity.class);
    ...
    private void addMarker(GeoPoint g) {
        ...
        this.mapView.invalidate(); //To redraw the map
    }
